...
if (isset($_POST['cancel_order_id'])) {
    ...
    if (Database::query($cancel_query) === TRUE) {
        echo "<script>alert('Đơn hàng đã được hủy thành công.');</script>";
    } else {
        echo "<script>alert('Lỗi khi hủy đơn hàng.');</script>";
    }
}
...
$total_orders_result = Database::query($total_orders_query);
...
<head>
    <meta charset="utf-8">
    <title>Lịch sử đơn hàng - HPL FASHION</title>
        ...
        <div class="container py-5 h-100">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-lg-10 col-xl-8">
                    <table>
                        ...
                        <?php foreach ($orders as $order): ?>
                            <tr>
                                ...
                                $status_result = Database::query($status_query);
                                ...
                                <td>
                                    ...
                                    <div id="order-detail-<?php echo $order['order_id']; ?>" class="collapse order-detail">
                                        ...
                                        $order_details_result = Database::query($order_details_query);
                    ...
                    <br>
                    <nav aria-label="Phân trang" class="d-flex justify-content-center">
                        <ul class="pagination">
